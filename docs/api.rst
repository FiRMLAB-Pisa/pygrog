...
Sparse FFT and Toeplitz operators for Cartesian-undersampled MRI.
...
.. autosummary::
   ...
   pygrog.interop.GrogFourierOp
   pygrog.interop.GrogLinop
   pygrog.interop.GrogLinearOp
   pygrog.interop.sparse_fft_forward
   pygrog.interop.sparse_fft_adjoint
